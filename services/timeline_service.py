...
class TimelineService:
    """Service for transforming Sentry Agentic data to Timesketch timeline format."""
        ...
        for timeline_event in timeline:
            ...
            if event_timestamp:
                ...
                event = {
                    ...
                    'source': 'Sentry Agentic Case Timeline',
                    'source_short': 'DT-CASE',
