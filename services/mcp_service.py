...
class MCPServer:
    ...
    def is_running(self) -> bool:
        ...
        try:
            # Extract module name from args (e.g., "tools.sentry_findings" -> "sentry_findings")
            module_name = None
    ...
    def get_log_path(self) -> Path:
        ...
        # Keep hyphens as servers log to files with hyphens (e.g., sentry-findings.log)
...
class MCPService:
    ...
    _STATE_FILE = Path.home() / ".sentry" / "mcp_server_enabled.json"
    ...
    _DEFAULT_ENABLED = {"sentry-findings", "sentry-flow", "security-detections", "approval", "attack-layer", "mempalace"}
    ...
    def _detect_server_type(self, args: List[str]) -> str:
        ...
        FastMCP servers: sentry_findings
    ...
    def _get_default_servers(self, python_exe_str: str, project_path_str: str) -> List[Dict]:
        ...
        return [
            {
                "name": "sentry-findings",
                "command": python_exe_str,
                "args": ["-m", "tools.sentry_findings"],
                "cwd": project_path_str,
                "env": {"PYTHONPATH": project_path_str},
                "server_type": "fastmcp"
            }
