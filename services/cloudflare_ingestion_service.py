...
summary) into a Sentry Agentic finding. Because the public Cloudy webhook contract is
...
class CloudyIngestionService:
    """Build Sentry Agentic findings from Cloudflare Cloudy event payloads."""
    ...
    def transform_event(self, payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """Map a Cloudy webhook payload to a Sentry Agentic finding dict.
