...
MCP tools, and the shape of the Sentry Agentic base prompt.
...
class AgentAIGenerator:
    ...
    def _build_system_prompt(self) -> str:
        return (
            "You are a SOC agent designer for the Sentry Agentic platform. "
        ...
        parts.extend(
            [
                ...
                (
                    ...
                    "rendered into this template (Sentry Agentic preserves the "
                ...
                (
                    ...
                    "\"You are a SOC {role} in the Sentry Agentic platform.\"\n"
                    "- `extra_principles` is added AFTER Sentry Agentic's baseline "
    ...
    def _base_prompt_shape(self) -> str:
        return (
            "You are a SOC {role} in the Sentry Agentic platform.\n"
            "\n"
            "<entity_recognition> ... </entity_recognition>  (preserved by Sentry Agentic)\n"
            "<available_tools> ... </available_tools>       (preserved by Sentry Agentic)\n"
            "<memory_operations> ... </memory_operations>   (preserved by Sentry Agentic)\n"
            "\n"
            "<principles>\n"
