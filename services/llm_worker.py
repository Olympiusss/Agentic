...
async def llm_call(
    ...
    try:
        ...
        _tracer = get_tracer("sentry-agentic.services.llm_worker")
...
def _sync_claude_raw(
    ...
    *,
    ...
    # #185: tag the upstream Bifrost call with a Sentry Agentic interaction UUID
...
async def on_startup(ctx: Dict[str, Any]):
    ...
    try:
        ...
        init_telemetry("sentry-agentic-llm-worker")
