...
try:
    ...
    _tracer = get_tracer("sentry-agentic.daemon.agent_runner")
except Exception:
...
def compute_call_cost(
    ...
    which after #84 PR-C is most of Sentry Agentic's traffic.
        ...
        try:
            if _tracer is not None:
                ...
                _agent_span = _tracer.start_span(
                    ...
                    attributes={
                        "sentry-agentic.investigation.id": inv_id,
                        "sentry-agentic.investigation.workflow_id": investigation.get(
                            "workflow_id", ""
                        ),
                    },
                )
        ...
        try:
                ...
                try:
                    if _tracer is not None:
                        _iter_span = _tracer.start_span(
                            ...
                            attributes={
                                "sentry-agentic.investigation.id": inv_id,
                                "sentry-agentic.agent.iteration": iteration,
                                "sentry-agentic.investigation.current_step": state.get(
                                    "current_step", 1
                                ),
                            },
                        )
            ...
            try:
                if _agent_span is not None:
                    _agent_span.set_attribute("sentry-agentic.agent.total_iterations", iteration)
    ...
    async def _execute_external_tool(
        ...
        try:
            if _tracer is not None:
                _tool_span = _tracer.start_span(
                    ...
                    attributes={
                        "sentry-agentic.investigation.id": inv_id,
                        "sentry-agentic.tool.name": tool_name,
                        "sentry-agentic.tool.tier": tier,
                        "sentry-agentic.tool.input_size": len(
        ...
        if tier == "forbidden":
            ...
            try:
                if _tool_span is not None:
                    _tool_span.set_attribute("sentry-agentic.tool.success", False)
                    _tool_span.end()
            except Exception:
                pass
            return msg
        ...
        if self._claude_service and hasattr(
            ...
            try:
                ...
                if result is not None:
                    ...
                    try:
                        if _tool_span is not None:
                            _tool_span.set_attribute("sentry-agentic.tool.success", True)
                            _tool_span.set_attribute("sentry-agentic.tool.output_size", len(_r))
                            _tool_span.set_attribute(
                                "sentry-agentic.tool.duration_ms",
                    ...
                    if result is not None:
                        ...
                        try:
                            if _tool_span is not None:
                                _tool_span.set_attribute("sentry-agentic.tool.success", True)
                                _tool_span.set_attribute(
                                    "sentry-agentic.tool.output_size", len(_r)
                                )
                                _tool_span.set_attribute(
                                    "sentry-agentic.tool.duration_ms",
                                    round((_time.monotonic() - _t0) * 1000, 1),
        ...
        try:
            if _tool_span is not None:
                _tool_span.set_attribute("sentry-agentic.tool.success", False)
                _tool_span.set_attribute(
                    "sentry-agentic.tool.duration_ms", round((_time.monotonic() - _t0) * 1000, 1)
                )
                _tool_span.end()
        except Exception:
            pass
