...
try:
    ...
    _tracer = get_tracer("sentry-agentic.daemon.orchestrator")
    _orch_meter = get_meter("sentry-agentic.daemon.orchestrator")
            ...
            if _tracer is not None:
                _inv_span = _tracer.start_span(
                    ...
                    attributes={
                        ...
                        "sentry-agentic.investigation.workflow_id": workflow_id,
                        "sentry-agentic.investigation.trigger_type": trigger_type,
                        "sentry-agentic.investigation.priority": priority,
                        "sentry-agentic.investigation.finding_count": len(findings),
                    },
                )
                _tp_carrier: Dict = {}
