...
### 1. Enhanced MCP Tools (`tools/sentry_findings.py`)
...
3. Selects tool: sentry-findings_add_finding_to_case
...
1. Add function to `tools/sentry_findings.py`
