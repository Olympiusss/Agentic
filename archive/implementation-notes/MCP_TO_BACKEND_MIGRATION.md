...
| Function | MCP Tool Name | Backend Tool Name | Status |
|----------|--------------|------------------|--------|
| List findings | `sentry-findings_list_findings` | `list_findings` | ✅ Migrated |
| Get finding | `sentry-findings_get_finding` | `get_finding` | ✅ Migrated |
| Similar findings | `sentry-findings_nearest_neighbors` | `nearest_neighbors` | ✅ Migrated |
| List cases | `sentry-findings_list_cases` | `list_cases` | ✅ Migrated |
| Get case | `sentry-findings_get_case` | `get_case` | ✅ Migrated |
| Create case | `sentry-findings_create_case` | `create_case` | ✅ Migrated |
| Add to case | `sentry-findings_add_finding_to_case` | `add_finding_to_case` | ✅ Migrated |
