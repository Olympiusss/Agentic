...
Complete guide to the CI/CD pipeline for Sentry Agentic.
...
Sentry Agentic uses **GitHub Actions** for CI/CD with three main workflows:
...
docker images | grep sentry-agentic
