...
The Sentry Agentic platform supports **backend tool integration** via Claude Agent SDK. This enables autonomous tool execution through the Claude API with no desktop dependency.
