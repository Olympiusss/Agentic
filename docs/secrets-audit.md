...
Snapshot of how Sentry Agentic handles credentials at rest today, and the gaps that
...
## How Sentry Agentic stores secrets today
...
2. **`~/.sentry/.env`** — per-user dotenv file, chmod `0o600`. Default
