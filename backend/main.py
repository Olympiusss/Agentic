"""
FastAPI Backend for Sentry Agentic Web Application
...
try:
    ...
    init_telemetry("sentry-agentic-backend")
...
# Create FastAPI app
app = FastAPI(
    title="Sentry Agentic API",
    description="REST API for Sentry Agentic Application",
    version=__version__,
)
...
async def startup_event():
    ...
    logger.info("=" * 60)
    logger.info("Starting Sentry Agentic Backend")
    logger.info("=" * 60)
...
if __name__ == "__main__":
    ...
    logger.info("Starting Sentry Agentic API server...")
    uvicorn.run(
