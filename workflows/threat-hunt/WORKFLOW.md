...
trigger-examples:
  ...
  - "Validate whether this Sentry Agentic C2 alert is real by checking all available threat intel for the public IP"
...
- Validating a flagged alert (e.g., Sentry Agentic C2 detection) against all available sources
...
```
User: "Validate whether this Sentry Agentic C2 alert is real by checking all threat intel for IP 185.220.101.1"
```
