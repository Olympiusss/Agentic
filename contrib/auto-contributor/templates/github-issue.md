...
### How it works
[3-5 bullet points describing the implementation approach. Be specific about inputs, outputs, and how this connects to existing Sentry Agentic components.]

### Interfaces
- **Input:** [What data this component consumes — e.g., ARTEMIS findings JSON, Sentry Agentic findings database]
...
- [Link to relevant Sentry Agentic docs]
