          ...
          <Stack spacing={2}>
            ...
            <Typography variant="subtitle2" sx={{ mt: 1 }}>
              ...
              <Typography variant="caption" component="span" color="text.secondary" sx={{ ml: 1 }}>
                Rendered into the Sentry Agentic base prompt (preserves mempalace + entity-recognition directives)
              </Typography>
            </Typography>
            <TextField
              label="Role"
              ...
              helperText='Renders as: "You are a SOC {role} in the Sentry Agentic platform."'
