#!/bin/bash
# Start Sentry Agentic Web Application (Updated for 2.0)

set -e

echo "=========================================="
echo "Sentry Agentic v2.0 - Startup"
echo "=========================================="
...
if command -v docker &> /dev/null; then
    if docker ps --format '{{.Names}}' | grep -q "sentry-postgres"; then
        ...
        for i in {1..30}; do
            if docker exec sentry-postgres pg_isready -U postgres &> /dev/null 2>&1; then
...
echo ""
echo "=========================================="
echo "✅ Sentry Agentic v2.0 - Ready!"
echo "=========================================="
