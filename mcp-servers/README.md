# Sentry Agentic MCP Servers

Model Context Protocol (MCP) servers for Sentry Agentic AI SOC.

## Overview

This package provides 4 MCP servers for Sentry Agentic AI SOC:

1. **sentry-findings** - Findings and case management (FastMCP)
...
# Install sentry-core dependency first
pip install -e ../sentry-core

# Install from git
pip install git+https://github.com/YOUR_USERNAME/sentry-mcp-servers.git
```
...
```bash
# sentry-findings server (FastMCP)
python servers/sentry_findings.py
...
```json
{
  "mcpServers": {
    "sentry-findings": {
      "command": "python3",
      "args": ["/path/to/sentry-mcp-servers/servers/sentry_findings.py"],
      "cwd": "/path/to/your/project"
    },
    "sentry-flow": {
      "command": "python3",
      "args": ["/path/to/sentry-mcp-servers/servers/tempo_flow.py"],
      "cwd": "/path/to/your/project"
    },
    "approval": {
      "command": "python3",
      "args": ["/path/to/sentry-mcp-servers/servers/approval.py"],
      "cwd": "/path/to/your/project"
    },
    "attack-layer": {
      "command": "python3",
      "args": ["/path/to/sentry-mcp-servers/servers/attack_layer.py"],
      "cwd": "/path/to/your/project"
    }
  }
}
...
The servers use configuration from `sentry-core`. Set environment variables:
...
├── servers/
│   ├── __init__.py
│   ├── sentry_findings.py  # FastMCP server
