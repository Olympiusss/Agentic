...
-- Grant Permissions
-- ============================================================================
GRANT SELECT, INSERT, UPDATE, DELETE ON system_config TO sentry;
GRANT SELECT, INSERT, UPDATE, DELETE ON user_preferences TO sentry;
GRANT SELECT, INSERT, UPDATE, DELETE ON integration_configs TO sentry;
GRANT SELECT, INSERT ON config_audit_log TO sentry;
GRANT USAGE, SELECT ON SEQUENCE config_audit_log_id_seq TO sentry;
GRANT SELECT ON enabled_integrations TO sentry;
GRANT SELECT ON recent_config_changes TO sentry;
