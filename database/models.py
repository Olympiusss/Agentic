"""
SQLAlchemy Database Models for Sentry Agentic
...
class Finding(Base):
    """Finding model - represents a security finding from Sentry Agentic LogLM."""
...
class SystemConfig(Base):
    ...
    This replaces file-based configs in ~/.sentry/ for better multi-user
...
class LLMInteractionLog(Base):
    ...
    # made under so we can group spend per-tenant once Sentry Agentic grows a
