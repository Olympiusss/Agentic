...
class TestSubstituteEnvVars:
    ...
    def test_nested_substitution_in_default(self, monkeypatch):
        ...
        assert (
            service._substitute_env_vars("${UNSET_VAR_XYZ:-${HOME}/.sentry-agentic/palace}")
            == "/Users/test/.sentry-agentic/palace"
        )
    ...
    def test_mempalace_config_path(self, monkeypatch):
        ...
        result = service._substitute_env_vars(
            "${MEMPALACE_PALACE_PATH:-${HOME}/.sentry-agentic/mempalace/palace}"
        )
        assert result == "/Users/test/.sentry-agentic/mempalace/palace"
