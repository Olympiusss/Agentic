...
class TestSensitiveAttributeScrubber:
    ...
    @pytest.mark.parametrize(
        ...
        [
            "http.method",
            "http.status_code",
            "sentry-agentic.tool.name",
            "sentry-agentic.tool.tier",
            "sentry-agentic.investigation.id",
    ...
    def test_short_benign_values_not_redacted(self, scrubber):
        ...
        assert scrubber._should_redact("sentry-agentic.tool.tier", "safe") is False
    ...
    def test_numeric_values_not_redacted(self, scrubber):
        ...
        assert scrubber._should_redact("sentry-agentic.llm.cost_usd", 0.0255) is False
    ...
    def test_dsn_substring_false_positive(self, scrubber):
        ...
        assert scrubber._should_redact("sentry-agentic.dsnark", "hello") is False
