...
could not reference Sentry Agentic's autonomous-response capability. The fix
...
See: https://github.com/Sentry Agentic-SOC/sentry-agentic/issues/204
"""
...
def _load_script_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "sentry-agentic_create_workflow", REPO / "scripts" / "create_workflow.py"
    )
