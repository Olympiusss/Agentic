...
(async () => {
  ...
  try {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const hasServerData = /sentry|tempo-flow|approval|attack-layer|connected|servers/i.test(chatContent);
    ...
    const serverNames = ['sentry-findings', 'tempo-flow', 'approval', 'attack-layer'];
