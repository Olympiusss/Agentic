#!/usr/bin/env python3
"""
Schema migration script for Sentry Agentic.
...
def get_connection_url():
    ...
    pw = os.environ.get('POSTGRES_PASSWORD', 'sentry_secure_password_change_me')
    db = os.environ.get('POSTGRES_DB', 'sentry_soc')
...
def seed_default_admin(conn):
    ...
    conn.execute(text("""
        ...
        VALUES ('user-admin', 'admin', 'admin@sentry.local', :pw, 'Administrator', 'admin',
