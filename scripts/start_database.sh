#!/bin/bash
# Start PostgreSQL database for Sentry Agentic v2.0

set -e

echo "=================================================="
echo "Sentry Agentic v2.0 - Database Startup"
echo "=================================================="
...
for i in {1..30}; do
    if docker exec sentry-postgres pg_isready -U postgres -d sentry &> /dev/null; then
