...
Case Management:
  - sentry-findings_create_case
  - sentry-findings_add_finding_to_case
  - sentry-findings_bulk_add_findings_to_case
  - sentry-findings_add_case_activity
  - sentry-findings_add_case_timeline_entry
  - sentry-findings_add_case_mitre_techniques
  - sentry-findings_add_resolution_step
  - sentry-findings_create_case_from_killchain
  - sentry-findings_update_case
  - sentry-findings_get_case
  - sentry-findings_list_cases

Example tool call (via MCP):
{
  "tool": "sentry-findings_add_finding_to_case",
  "arguments": {
