#!/usr/bin/env python3
"""Scaffold a new Sentry Agentic workflow directory with a commented WORKFLOW.md template.
...
def main():
    parser = argparse.ArgumentParser(
        description="Scaffold a new Sentry Agentic workflow with a WORKFLOW.md template.",
...
""",
    ...
    print(f"  2. Say \"Run {workflow_id} on finding <id>\" in the Sentry Agentic chat")
    print()
