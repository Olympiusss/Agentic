...
This script ensures that default admin credentials are inserted into PostgreSQL, allowing first-time login to the Sentry Agentic system.

## Default Credentials

- **Username**: `admin`
- **Password**: `admin123`
- **Email**: `admin@sentry.ai`
...
```
==================================================
Sentry Agentic - Default Credentials Setup
==================================================
...
```sql
-- Connect to database
docker exec -it sentry-postgres psql -U sentry -d sentry_soc
