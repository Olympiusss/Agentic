#!/usr/bin/env python3
"""
Sample Data Generator for Sentry Agentic
...
def main():
    parser = argparse.ArgumentParser(description="Generate sample data for Sentry Agentic")
    ...
    print("\n" + "="*60)
    print(" Sentry Agentic - Sample Data Generator")
    print("="*60)
