"""
Database connection management for Sentry Agentic AI SOC.
...
from sentry_core.database.models import Base
...
class DatabaseConfig:
    ...
    def __init__(self):
        ...
        self.database = os.getenv('POSTGRES_DB', 'sentry_soc')
        self.user = os.getenv('POSTGRES_USER', 'sentry')
        self.password = os.getenv('POSTGRES_PASSWORD', 'sentry_secure_password_change_me')
